...
![nginx-t](src/assets/docs-deployment/nginx-t.png)
...
```
![nginx-status](src/assets/docs-deployment/nginx-status.png)
...
```
![status-fail2ban](src/assets/docs-deployment/status-fail2ban.png)
